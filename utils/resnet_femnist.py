...
class ResNet(hk.Module):
  ...
  CONFIGS = {
      14: {
          "blocks_per_group": (1, 2, 2, 1),
          "bottleneck": False,
          "channels_per_group": (32, 64, 128, 256),
          "use_projection": (False, True, True, True),
      },    
      20: {
          "blocks_per_group": (2, 3, 2, 2),
          "bottleneck": False,
          "channels_per_group": (32, 64, 128, 256),
          "use_projection": (False, True, True, True),
      },
      34: {
          "blocks_per_group": (3, 4, 5, 3),
          "bottleneck": False,
          "channels_per_group": (32, 64, 128, 256),
          "use_projection": (False, True, True, True),
      }
  ...
  def __init__(
      ...
      channels_per_group: Sequence[int] = (32, 64, 128, 256),
    ...
    initial_conv_config.setdefault("output_channels", 32)
